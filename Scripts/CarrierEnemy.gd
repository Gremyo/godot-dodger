...
var spawned_mob_distance = Vector2(75,0).rotated(PI/2)
...
func _on_CarrierEnemyTimer_timeout():
	...
	spawned_mob_1.position += spawned_mob_distance
	spawned_mob_2.position -= spawned_mob_distance
	...
	add_child(spawned_mob_1)
	add_child(spawned_mob_2)
